...
// MARK: -
fileprivate func canShowLogs() -> Bool {
...
fileprivate func getCompleteMessage(message: String, file: String = #file, function: String = #function, line: Int = #line) -> String {
...
@available(iOS 10.0, *)
fileprivate func fileManager(message: String,
                             type: LogType,
                             logger: OSLog) {
...
@available(iOS 10.0, *)
fileprivate func sendLog(message: String, type: LogType, logger: OSLog) {
...
fileprivate func sendLog(message: String) {
  switch logFunctionType {
  case .print:
    print(message)
    break
