...
class LoginViewController: UIViewController {
    ...
    var presenterDelegate: LoginViewPresenter!
...
//        self.delegateSetup()
    ...
    /* If you want to use dependency injection for loosing coupling and for increasing testability you can setup delegate at the time of routing. for reference you can also see method commented in viewController file at routing of loginViewController */
    
    //Delegate setup without dependency injection
//    private func delegateSetup() {
//        self.presenterDelegate = LoginViewPresenterImplementation(view: self)
//    }
//
    //Setup Tableview
...
extension LoginViewController: SignupView {
...
extension LoginViewController: InputTextFieldCellDelegate {
...
//            return
//        }
//        return presenter.infoTapped(at: index)
    }
}

extension LoginViewController: SignupButtonCellDelegate {
